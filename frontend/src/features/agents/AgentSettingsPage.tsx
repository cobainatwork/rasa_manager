    ...
    <form onSubmit={handleSubmit(onSubmit)} className="p-8 max-w-3xl">
      ...
      <Card className="p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <Button type="button" variant="outline" onClick={handleTestConnection} disabled={testingConn}>
      ...
      <Card className="p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <Button type="button" variant="outline" onClick={handleValidateScript} disabled={validatingScript}>
            {validatingScript ? '驗證中...' : '驗證腳本存在性'}
          </Button>
        </div>
      </Card>
