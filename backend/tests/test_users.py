...
class TestValidatePassword:
    def test_valid_password_no_exception(self) -> None:
    ...
    def test_no_uppercase_raises_400(self) -> None:
        with pytest.raises(HTTPException) as exc:
            _validate_password("admin1234")
        assert exc.value.status_code == 400

    def test_no_lowercase_raises_400(self) -> None:
        with pytest.raises(HTTPException) as exc:
            _validate_password("ADMIN1234")
        assert exc.value.status_code == 400

    def test_no_digit_raises_400(self) -> None:
        with pytest.raises(HTTPException) as exc:
    ...
    def test_7_chars_raises(self) -> None:
...
class TestListUsers:
    def test_superadmin_returns_200_and_list(self, client_superadmin, mock_db) -> None:
        user = _user_mock()
    ...
    def test_non_superadmin_returns_403(self, client_editor, mock_db) -> None:
        resp = client_editor.get("/api/v1/users")
        assert resp.status_code == 403

    def test_empty_db_returns_empty_list(self, client_superadmin, mock_db) -> None:
...
class TestCreateUser:
    ...
    def test_superadmin_flag_true(self, client_superadmin, mock_db) -> None:
        mock_db.query.return_value.filter.return_value.first.return_value = None
        resp = client_superadmin.post(
            "/api/v1/users",
    ...
    def test_duplicate_username_returns_409(self, client_superadmin, mock_db) -> None:
    ...
    def test_short_password_returns_422(self, client_superadmin, mock_db) -> None:
    ...
    def test_no_uppercase_password_returns_400(self, client_superadmin, mock_db) -> None:
        resp = client_superadmin.post(
            "/api/v1/users",
...
class TestUpdateUser:
    def test_deactivate_user_returns_200(self, client_superadmin, mock_db) -> None:
        user = _user_mock()
    ...
    def test_promote_to_superadmin_returns_200(self, client_superadmin, mock_db) -> None:
        user = _user_mock()
        mock_db.query.return_value.filter.return_value.first.return_value = user
        resp = client_superadmin.patch(
            f"/api/v1/users/{USER_ID}",
...
class TestResetPassword:
    def test_success_returns_200(self, client_superadmin, mock_db) -> None:
        user = _user_mock()
        mock_db.query.return_value.filter.return_value.first.return_value = user
        resp = client_superadmin.patch(
    ...
    def test_weak_password_returns_400(self, client_superadmin, mock_db) -> None:
        resp = client_superadmin.patch(
            f"/api/v1/users/{USER_ID}/reset-password",
    ...
    def test_no_uppercase_returns_400(self, client_superadmin, mock_db) -> None:
        resp = client_superadmin.patch(
            f"/api/v1/users/{USER_ID}/reset-password",
